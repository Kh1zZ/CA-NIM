    ...
    fun openDetail(item: Any, type: MediaType) {
        ...
        val initialDetail = cachedDetail ?: when (resolvedItem) {
            is UserMediaItem -> ExtendedMediaDetail(
                ...
                format = resolvedItem.metadata.format,
                episodes = resolvedItem.metadata.totalEpisodes,
                chapters = resolvedItem.metadata.totalChapters,
                volumes = resolvedItem.metadata.totalVolumes,
            ...
            is MediaItem -> ExtendedMediaDetail(
                ...
                episodes = resolvedItem.episodes,
                chapters = resolvedItem.chapters,
                volumes = resolvedItem.volumes,
                            ...
                            if (malDetail != null && token == detailRequestToken) {
                                _detailState.update { current ->
                                    ...
                                    val merged = (currentExt ?: malDetail).copy(
                                        ...
                                        format = currentExt?.format ?: malDetail.format,
                                        episodes = currentExt?.episodes ?: malDetail.episodes,
                                        chapters = currentExt?.chapters ?: malDetail.chapters,
                                        volumes = currentExt?.volumes ?: malDetail.volumes,
                ...
                if (aniDetail != null && token == detailRequestToken) {
                    ...
                    _detailState.update { current ->
                        ...
                        val merged = aniDetail.copy(
                            ...
                            format = aniDetail.format ?: currentExt?.format,
                            episodes = aniDetail.episodes ?: currentExt?.episodes,
                            chapters = aniDetail.chapters ?: currentExt?.chapters,
                            volumes = aniDetail.volumes ?: currentExt?.volumes,
